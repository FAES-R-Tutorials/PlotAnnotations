...
```{r a8-setup, results='hide', echo=FALSE}
library(ggrepel) 
pointsToLabel <- c("Russia", "Venezuela", "Iraq", "Myanmar", "Sudan",
                   "Afghanistan", "Congo", "Greece", "Argentina", "Brazil",
                   "India", "Italy", "China", "South Africa", "Spane",
...
```{r a8, exercise=TRUE, exercise.eval=TRUE, echo = T, exercise.lines = 20, exercise.setup='a8-setup'}
econ_data$Region <- 
...
```{r a9, echo=TRUE, exercise=TRUE, exercise.eval=FALSE, exercise.setup='a9setup'}
...
```{r a13-setup, echo=F, results='hide'}
plt_corrupt <- 
   plt +
  labs(title = 'Corruption and Human Development')
...
```{r a13, exercise.setup='a13-setup',exercise=TRUE,}
library(extrafont)
plt_corrupt + 
